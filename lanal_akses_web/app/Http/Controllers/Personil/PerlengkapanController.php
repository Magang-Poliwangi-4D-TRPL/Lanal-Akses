...
class PerlengkapanController extends Controller
{
    public function index($nrp) {
        ...
        if($personil == null){
            ...
            return view('personil.perlengkapan.index', compact('personil', 'perlengkapan'));
        }
    ...
    public function create($nrp)
    {
        $nrpGanti = str_replace('-', '/', $nrp);
        $personil = PersonilModel::where('nrp', $nrpGanti)->first();
        return view('personil.perlengkapan.create', compact('personil'));
    }
    ...
    public function store(Request $request, $nrp)
    {
        ...
        return redirect()->route('personel.perlengkapan.index', ['nrp' => $nrp])
    ...
    public function destroy($nrp, $perlengkapanId)
    {
        ...
        if ($perlengkapan == null) {
            return redirect()->back()->withErrors(['message' => 'Data perlengkapan personel tidak ditemukan.']);
        }
    ...
    public function edit($nrp, $perlengkapanId)
    {
        ...
        return view('personil.perlengkapan.edit', compact('personil', 'perlengkapan'));
    }
    ...
    public function update(Request $request, $nrp, $perlengkapanId)
    {
        ...
        return redirect()->route('personel.perlengkapan.index', ['nrp' => $nrp])->with('success', 'Data perlengkapan personil berhasil diperbarui.');
    }
}
