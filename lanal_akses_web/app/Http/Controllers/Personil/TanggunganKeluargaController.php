...
class TanggunganKeluargaController extends Controller
{
    public function index($nrp) {
        ...
        if($personil == null){
            ...
            return view('personil.tanggungan-keluarga.index', compact('personil', 'tanggunganKeluarga'));
        }
    ...
    public function create($nrp)
    {
        $nrpGanti = str_replace('-', '/', $nrp);
        $personil = PersonilModel::where('nrp', $nrpGanti)->first();
        return view('personil.tanggungan-keluarga.create', compact('personil'));
    }
    ...
    public function store(Request $request, $nrp)
    {
        ...
        return redirect()->route('personel.tanggungan-keluarga.index', ['nrp' => $nrp])
    ...
    public function edit($nrp, $tanggunganKeluaragaId)
    {
        ...
        if ($tanggunganKeluarga == null) {
            return redirect()->back()->withErrors(['message' => 'Data tanggungan keluarga personel tidak ditemukan.']);
        }

        return view('personil.tanggungan-keluarga.edit', compact('personil', 'tanggunganKeluarga'));
    }
    ...
    public function update(Request $request, $nrp, $tanggunganKeluaragaId)
    {
        ...
        return redirect()->route('personel.tanggungan-keluarga.index', ['nrp' => $nrp])->with('success', 'Data tanggungan keluarga personil berhasil diperbarui.');
    }
