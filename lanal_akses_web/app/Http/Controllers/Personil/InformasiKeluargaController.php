...
class InformasiKeluargaController extends Controller
{
    public function index($nrp) {
        ...
        if($personil == null){
            ...
            return view('personil.informasi-keluarga.index', compact('personil', 'informasiPasangan', 'informasiAnak', 'informasiOrangTua'));
        }
    ...
    public function createInformasiPasangan($nrp){
        ...
        if($personil == null){
            ...
            return view('personil.informasi-keluarga.informasi-pasangan.create', compact('personil'));
        }
    }
    ...
    public function storeInformasiPasangan(Request $request, $nrp){
        ...
        if($personil == null){
            redirect()->back()->withErrors(['message' => 'Data personel tidak ditemukan.']);
        }
        ...
        return redirect()->route('personel.informasi-keluarga.index', ['nrp' => $nrp])
    ...
    public function editInformasiPasangan($nrp, $informasiPasanganId){
        ...
        if ($informasiPasangan == null) {
            return redirect()->back()->withErrors(['message' => 'Data informasi pasangan personel tidak ditemukan.']);
        }

        return view('personil.informasi-keluarga.informasi-pasangan.edit', compact('personil', 'informasiPasangan'));
    }
    ...
    public function updateInformasiPasangan(Request $request, $nrp, $informasiPasanganId) {
        ...
        return redirect()->route('personel.informasi-keluarga.index', ['nrp' => $nrp])->with('success', 'Data pasangan personil berhasil diperbarui.');
    ...
    public function createInformasiOrangTua($nrp){
        ...
        if($personil == null){
            ...
            return view('personil.informasi-keluarga.informasi-orang-tua.create', compact('personil'));
        }
    }
    ...
    public function editInformasiOrangTua($nrp, $informasiOrangTuaId){
        ...
        if ($informasiOrangTua == null) {
            return redirect()->back()->withErrors(['message' => 'Data informasi orang tua personel tidak ditemukan.']);
        }

        return view('personil.informasi-keluarga.informasi-orang-tua.edit', compact('personil', 'informasiOrangTua'));
    }
    ...
    public function updateInformasiOrangTua(Request $request, $nrp, $informasiOrangTuaId) {
        ...
        return redirect()->route('personel.informasi-keluarga.index', ['nrp' => $nrp])->with('success', 'Data orang tua personil berhasil diperbarui.');
    ...
    public function createInformasiAnak($nrp){
        ...
        if($personil == null){
            return redirect()->back()->withErrors(['message' => 'Data informasi anak personel tidak ditemukan.']);
        } else {
            return view('personil.informasi-keluarga.informasi-anak.create', compact('personil'));
        }
    }
    ...
    public function editInformasiAnak($nrp, $informasiAnakId){
        ...
        return view('personil.informasi-keluarga.informasi-anak.edit', compact('personil', 'informasiAnak'));
    }
    ...
    public function updateInformasiAnak(Request $request, $nrp, $informasiAnakId) {
        ...
        return redirect()->route('personel.informasi-keluarga.index', ['nrp' => $nrp])->with('success', 'Data anak personil berhasil diperbarui.');
