...
class LoginRequest extends FormRequest
{
    ...
    {
        return [
            'email.required_without' => 'Email harus diisi jika username tidak digunakan.',
            'email.email' => 'Format email yang dimasukkan tidak sesuai.',
            'username.required_without' => 'Username harus diisi jika email tidak digunakan.',
        ];
    }
