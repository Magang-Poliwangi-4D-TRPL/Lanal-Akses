                            ...
                            @forelse($pengajuanMenunggu as $pengajuan)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.surat-cuti.satker.show', $pengajuan->id) }}" class="btn btn-primary">Lihat Detail</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                            ...
                            @forelse($pengajuanSelesai as $pengajuan)
                                <tr>
                                    ...
                                    @php
                                        // Tentukan class berdasarkan status surat
                                        $statusClass = '';
                                        switch ($pengajuan->responCuti->status_atasan) {
                                            case 'Disetujui':
                                                $statusClass = 'bg-success text-white';
                                                break;
                                            case 'Menunggu Persetujuan':
                                    ...
                                    @endphp
                                    <td ><p class="p-1 rounded {{ $statusClass }} text-center">{{ $pengajuan->responCuti->status_atasan }}</p></td>
                                    <td>
                                        <!-- Contoh aksi untuk detail pengajuan cuti -->
                                        {{-- {{ route('pengajuan_cuti.show', $pengajuan->id) }} --}}
                                        <a href="{{ route('admin.surat-cuti.satker.show', $pengajuan->id) }}" class="btn btn-primary">Lihat Detail</a>
