                            ...
                            @forelse($pengajuanMenunggu as $pengajuan)
                                <tr>
                                    ...
                                    @php
                                        ...
                                        $statusClass = '';
                                        switch ($pengajuan->responCuti->status_palaksa) {
                                            case 'Disetujui':
                                    ...
                                    <td ><p class="p-1 rounded {{ $statusClass }} text-center">{{ $pengajuan->responCuti->status_palaksa }}</p></td>
                                    <td>
                                        <!-- Contoh aksi untuk detail pengajuan cuti -->
                                        {{-- {{ route('pengajuan_cuti.show', $pengajuan->id) }} --}}
                                        <a href="{{ route('admin.surat-cuti.palaksa.show', $pengajuan->id) }}" class="btn btn-primary">Lihat Detail</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
