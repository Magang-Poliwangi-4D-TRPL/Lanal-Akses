...
@section('title-page', 'Admin | Data Sisa Cuti')
        ...
        <div class="container-fluid mt-4 p-0">
            <div class="row p-4 justify-content-between align-item-center">
                <div class="col-md-6 py-auto">
                    <h4 class="h4 text-capitalize">Data Sisa Cuti Personel</h4>
                </div>
                <div class="col-md-6 py-auto text-right">
                    @if(auth()->user()->canany(['can access all']))
                    @if ($sisaCuti->count() != 0)
                    {{-- {{ route('admin.pegawai.create') }} --}}
                    <a href="{{ route('admin.sisa-cuti.update-all-cuti') }}" class="btn btn-info text-capitalize">Perbarui semua data cuti Personel <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                    </svg></a>
                    
                    @else
                    <a href="{{ route('admin.sisa-cuti.create') }}" class="btn btn-primary text-capitalize">Tambah Batas Cuti Tahunan <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                    </svg></a>
            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped" id="sisaCutiTable">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Personil</th>
                    ...
                    <tbody>
                        @forelse($sisaCuti as $sisaCutiItem)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td>{{ $sisaCutiItem->personil->nama_lengkap }}</td>
                            <td>{{ $sisaCutiItem->sisa_cuti }} hari</td>
                            <td>{{ $sisaCutiItem->batas_cuti }} hari/tahun</td>
                            <td>
                                <a href="{{ route('admin.sisa-cuti.edit', $sisaCutiItem->id) }}" class="btn btn-primary">Edit</a>
                            </td>
                        </tr>
                        @empty
                            <tr>
...
<script>
    document.getElementById('searchBox').addEventListener('keyup', function() {
        ...
        let table = document.getElementById('sisaCutiTable');
