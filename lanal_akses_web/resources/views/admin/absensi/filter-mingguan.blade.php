...
@section('title-page', 'Admin | Filter Mingguan Presensi')
...
<div class="container bg-white border rounded p-4 mt-4 ">
    <div class="container">
        ...
        <form method="POST" action="{{ route('admin.absensi.filter-mingguan.index') }}">
            @csrf
            <div class="form-group">
                <div class="input-group date">
                    <label class="col-md-4" for="startDate">Massukkan tanggal absensi</label>
                    <input type="date" class="col-md-8 form-control @error('startDate') is-invalid @enderror" id="startDate" name="startDate" placeholder="tanggal absensi" value="{{ old('startDate') }}">
                </div>
            </div>
