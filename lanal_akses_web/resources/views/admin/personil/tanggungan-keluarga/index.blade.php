                    ...
                    @foreach ($tanggunganKeluarga as $data_tanggungan_keluarga)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.personil.tanggungan-keluarga.destroy', ['nrp' => $nrpGanti, 'tanggunganKeluargaId' => $data_tanggungan_keluarga->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
