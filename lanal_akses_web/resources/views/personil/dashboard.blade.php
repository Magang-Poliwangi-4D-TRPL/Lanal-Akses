...
<style>
    ...
    @php
        ...
        $nrpGanti = str_replace('/', '-', $personil->nrp);
    @endphp
<a id="print-rh-button" class="text-decoration-none" target='_blank' href="{{ route('personel.cetak-riwayat-hidup', $personil->nrp) }}">
            ...
            <div class="col-md-5 mt-4">
                ...
                <div class="bg-white p-4 text-center col-12 ">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personil.editGambar') }}" class="btn btn-sm btn-outline-secondary">Edit foto personel</a>
                    </div>
                ...
                <div class="bg-white p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-end  my-3">
                        <!-- Tombol Edit Gambar -->
                        <a href="{{ route('personel.akun.edit', ['nrp'=> str_replace('/', '-', $personil->nrp), 'akunId' => Auth::user()->id]) }}" class="btn btn-sm btn-outline-secondary">Edit Akun</a>
                    </div>
                </div>
            </div>
            <div class="col-md-7 mt-4 bg-white">
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        @endphp
                        <a href="{{ route('personel.pendidikanmiliter.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Pendidikan Militer</a>
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.pendidikanformal.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Pendidikan Formal</a>
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.kursus.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Kursus</a>
                    </div>
                    <table class="table thead-light">
                        <thead>
                            <tr class="bg-blueaccent text-white text-bold">
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.tanggungan-keluarga.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Tanggungan Keluarga</a>
                    </div>
                    <table class="table thead-light">
                        <thead>
                            <tr class="bg-blueaccent text-white text-bold">
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.perlengkapan.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Perlengkapan</a>
                    </div>
                    <table class="table thead-light">
                        <thead>
                            <tr class="bg-blueaccent text-white text-bold">
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.tanda-jasa.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Tanda jasa</a>
                    </div>
                    <table class="table thead-light">
                        <thead>
                            <tr class="bg-blueaccent text-white text-bold">
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.data-kepangkatan.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Kepangkatan</a>
                    </div>
                    <table class="table thead-light">
                        <thead>
                            <tr class="bg-blueaccent text-white text-bold">
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.riwayat-penugasan.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Riwayat Penugasan</a>
                    </div>
                    <table class="table thead-light">
                        <thead>
                ...
                <div class="container ">
                    <div class="row d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('personel.sanksi-hukuman.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Sanksi Hukuman</a>
                    </div>
                    <table class="table thead-light">
                        <thead>
                            <tr class="bg-blueaccent text-white text-bold">
                ...
                <div class=" p-4">
                    <div class="container">
                        <div class="row d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('personel.informasi-keluarga.index', ['nrp' => $nrpGanti]) }}" class="btn btn-sm text-white btn-blue bg-bluedark">Kelola Informasi Keluarga</a>
                        </div>
                        @Empty(!$informasiPasangan)
