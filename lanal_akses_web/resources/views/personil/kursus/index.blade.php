...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">
            ...
            <a class="text-decoration-none" href="{{ route('personel.kursus.create', ['nrp' => $nrpGanti]) }}">
                ...
                @else
                    @foreach ($kursus as $data_kursus)
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="{{ route('personel.kursus.edit', ['nrp' => $nrpGanti, 'kursusId' => $data_kursus->id]) }}">
                                ...
                                <form action="{{ route('personel.kursus.destroy', ['nrp' => $nrpGanti, 'kursusId' => $data_kursus->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
