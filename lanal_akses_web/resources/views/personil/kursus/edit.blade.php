    ...
    <div class="container">
        <div class="container">
            ...
            <div class="container bg-white border rounded p-5 mt-4">
                ...
                @endphp
                <form method="POST" action="{{ route('personel.kursus.update', ['nrp' => $nrpGanti, 'kursusId' => $kursus->id]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <a class="text-decoration-none btn btn-blue text-white bg-gray" href="{{ route('personel.kursus.index', $nrpGanti) }}">
