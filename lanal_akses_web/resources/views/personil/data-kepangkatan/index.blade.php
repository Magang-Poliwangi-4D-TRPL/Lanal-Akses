...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">
            ...
            <a class="text-decoration-none" href="{{ route('personel.data-kepangkatan.create', ['nrp' => $nrpGanti]) }}">
                ...
                @else
                    @foreach ($dataKepangkatan as $item_dataKepangkatan)
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="{{ route('personel.data-kepangkatan.edit', ['nrp' => $nrpGanti, 'dataKepangkatanId' => $item_dataKepangkatan->id]) }}">
                                ...
                                {{--  --}}
                                <form action="{{ route('personel.data-kepangkatan.destroy', ['nrp' => $nrpGanti, 'dataKepangkatanId' => $item_dataKepangkatan->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
