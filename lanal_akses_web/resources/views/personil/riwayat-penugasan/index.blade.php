...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">
            ...
            <a class="text-decoration-none" href="{{ route('personel.riwayat-penugasan.create', ['nrp' => $nrpGanti]) }}">
                ...
                @else
                    @foreach ($riwayatPenugasan as $data_riwayatPenugasan)
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="{{ route('personel.riwayat-penugasan.edit', ['nrp' => $nrpGanti, 'riwayatPenugasanId' => $data_riwayatPenugasan->id]) }}">
                                ...
                                {{--  --}}
                                <form action="{{ route('personel.riwayat-penugasan.destroy', ['nrp' => $nrpGanti, 'riwayatPenugasanId' => $data_riwayatPenugasan->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
