    ...
    <div class="container">
        <div class="container">
            ...
            <div class="container bg-white border rounded p-5 mt-4">
                ...
                @endphp
                {{-- {{ route('personel.riwayat-penugasan.update', ['nrp' => $nrpGanti, 'riwayatPenugasanId' => $riwayatPenugasan->id]) }} --}}
                <form method="POST" action="{{ route('personel.riwayat-penugasan.update', ['nrp' => $nrpGanti, 'riwayatPenugasanId' => $riwayatPenugasan->id]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" placeholder="Keterangan" value="{{ $riwayatPenugasan->keterangan }}">
                      @error('keterangan')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                    ...
                    <a class="text-decoration-none btn btn-blue text-white bg-gray" href="{{ route('personel.riwayat-penugasan.index', $nrpGanti) }}">
