...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">            
            @if($user->count() == 0)
            <a class="text-decoration-none" href="{{ route('personel.akun.create', ['nrp' => str_replace('/', '-', $personil->nrp)]) }}">
            ...
            @else
            <a class="text-decoration-none" href="{{ route('personel.akun.edit', ['nrp' => str_replace('/', '-', $personil->nrp), 'akunId' => $user[0]->id],) }}">
