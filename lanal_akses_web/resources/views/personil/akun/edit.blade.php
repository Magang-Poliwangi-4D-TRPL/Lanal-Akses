...
@section('title-page', 'Personil | Edit data akun')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-greenmain text-white">Edit Akun Personel</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('personel.akun.update',['nrp' => str_replace('/', '-', $personil->nrp), 'akunId'=>$user[0]->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <a href="{{ route('personel.akun.index', str_replace('/', '-', $personil->nrp)) }}" class="btn btn-secondary">Kembali</a>
