...
@section('title-page', 'Personil | Data Pendidikan Personel')
...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">
            ...
            @endphp
            <a class="text-decoration-none" href="{{ route('personel.pendidikanformal.create', ['nrp' => $nrpGanti]) }}">
                ...
                @else
                    @foreach ($pendidikanFormal as $data_pendidikan)
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="{{ route('personel.pendidikanformal.edit', ['nrp' => $nrpGanti, 'pendidikanFormalId' => $data_pendidikan->id]) }}">
                                ...
                                <form action="{{ route('personel.pendidikanformal.destroy', ['nrp' => $nrpGanti, 'pendidikanFormalId' => $data_pendidikan->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
