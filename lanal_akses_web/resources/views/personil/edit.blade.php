...
@section('title-page', 'Personel | Edit Data Diri')
    ...
    <div class="container">
        <div class="container">
            ...
            <div class="container bg-white border rounded p-5 mt-4">
                ...
                @endphp
                <form method="POST" action="{{ route('personil.update', ['nrp' => $nrpGanti]) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                      <label for="nama_lengkap">Massukkan nama baru personel (Wajib diisi)</label>
                    ...
                    <div class="form-group">
                      <label for="jabatan">Massukkan jabatan baru personel(Wajib diisi)</label>
                    ...
                    <a class="text-decoration-none btn btn-blue text-white bg-gray" href="{{ route('personil.dashboard') }}">
