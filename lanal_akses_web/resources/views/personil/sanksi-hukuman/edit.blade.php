    ...
    <div class="container">
        <div class="container">
            ...
            <div class="container bg-white border rounded p-5 mt-4">
                ...
                @endphp
                {{--  --}}
                <form method="POST" action="{{ route('personel.sanksi-hukuman.update', ['nrp' => $nrpGanti, 'sanksiHukumanId' => $sanksiHukuman->id]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" placeholder="Keterangan" value="{{ $sanksiHukuman->keterangan }}">
                      @error('keterangan')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                    ...
                    <a class="text-decoration-none btn btn-blue text-white bg-gray" href="{{ route('personel.sanksi-hukuman.index', $nrpGanti) }}">
