...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">
            ...
            <a class="text-decoration-none" href="{{ route('personel.tanda-jasa.create', ['nrp' => $nrpGanti]) }}">
                ...
                @else
                    @foreach ($tandaJasa as $data_tandaJasa)
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="{{ route('personel.tanda-jasa.edit', ['nrp' => $nrpGanti, 'tandaJasaId' => $data_tandaJasa->id]) }}">
                                ...
                                {{--  --}}
                                <form action="{{ route('personel.tanda-jasa.destroy', ['nrp' => $nrpGanti, 'tandaJasaId' => $data_tandaJasa->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
