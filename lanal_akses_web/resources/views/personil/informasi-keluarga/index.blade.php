...
@section('title-page', 'Personil | Data Informasi Keluarga')
...
<div class="container">
    ...
    <div class="container bg-white py-4 border rounded p-5 mt-4">
        ...
        <div class="row d-flex justify-content-between align-items-center mb-4 border-bottom border-black">
            ...
            @if($informasiPasangan->count()==0)
                <a class="btn btn-blue btn-md text-white bg-blueaccent" href="{{ route('personel.informasi-pasangan.create', ['nrp' => $nrpGanti]) }}">
            ...
            @else
                <div class="row justify-content-between">
                    <a href="{{ route('personel.informasi-pasangan.edit', ['nrp' => $nrpGanti, 'informasiPasanganId' => $informasiPasangan[0]->id]) }}" class="btn btn-sm text-white btn-blue bg-bluedark mr-3">Edit data Pasangan <span><iconify-icon icon="clarity:note-line"></iconify-icon></span></a>
                    <form action="{{ route('personel.informasi-pasangan.delete', ['nrp' => $nrpGanti, 'informasiPasanganId' => $informasiPasangan[0]->id]) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
    ...
    <div class="container bg-white py-4 border rounded p-5 mt-4">
        <div class="row d-flex justify-content-between align-items-center mb-2 border-bottom border-black">
            ...
            @endphp
            {{--  --}}
            <a class="btn btn-blue btn-md text-white bg-blueaccent" href="{{ route('personel.informasi-anak.create', ['nrp' => $nrpGanti]) }}">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-sm-6 mt-4 py-4 border border-black rounded">
                ...
                <div class="px-4 row justify-content-end">
                    <a href="{{ route('personel.informasi-anak.edit', ['nrp' => $nrpGanti, 'informasiAnakId' => $dataInformasiAnak->id]) }}" class="btn btn-sm text-white btn-blue bg-bluedark mr-1">Edit data Anak <span><iconify-icon icon="clarity:note-line"></iconify-icon></span></a>
                    {{--  --}}
                    <form action="{{ route('personel.informasi-anak.delete', ['nrp' => $nrpGanti, 'informasiAnakId' => $dataInformasiAnak->id]) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
    ...
    <div class="container bg-white py-4 border rounded p-5 mt-4">
        <div class="row d-flex justify-content-between align-items-center mb-2 border-bottom border-black">
            ...
            @endphp
            {{--  --}}
            <a class="btn btn-blue btn-md text-white bg-blueaccent" href="{{ route('personel.informasi-orang-tua.create', ['nrp' => $nrpGanti]) }}">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-sm-6 mt-4 py-4 border border-black rounded">
                ...
                <div class="px-4 row justify-content-end">
                    <a href="{{ route('personel.informasi-orang-tua.edit', ['nrp' => $nrpGanti, 'informasiOrangTuaId' => $dataInformasiOrangTua->id]) }}" class="btn btn-sm text-white btn-blue bg-bluedark mr-1">Edit data orang tua <span><iconify-icon icon="clarity:note-line"></iconify-icon></span></a>
                    {{--  --}}
                    <form action="{{ route('personel.informasi-orang-tua.delete', ['nrp' => $nrpGanti, 'informasiOrangTuaId' => $dataInformasiOrangTua->id]) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
