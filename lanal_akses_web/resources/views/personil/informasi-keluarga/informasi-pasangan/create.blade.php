...
@section('title-page', 'Tambah data pasangan')

@section('content')
    <div class="container">
        <div class="container">
            <div class="container text-center">
                <h1>Tambah data pasangan</h1>
            </div>
            ...
            <div class="container bg-white border rounded p-5 mt-4">
                ...
                @endphp
                <form method="POST" action="{{ route('personel.informasi-pasangan.store', ['nrp' => $nrpGanti]) }}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="suku_bangsa" name="suku_bangsa" placeholder="Suku Bangsa" value="{{ old('suku_bangsa') }}">
                        </div>
                        @error('suku_bangsa')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="tinggi_badan" name="tinggi_badan" placeholder="00" value="{{ old('tinggi_badan') }}">
                        </div>
                        @error('tinggi_badan')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="berat_badan" name="berat_badan" placeholder="00" value="{{ old('berat_badan') }}">
                        </div>
                        @error('berat_badan')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" id="pekerjaan" name="pekerjaan" value="{{ old('pekerjaan')}}" placeholder="Pekerjaan pasangan">
                        @error('pekerjaan')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('alamat_sekarang') is-invalid @enderror" id="alamat_sekarang" name="alamat_sekarang" value="{{ old('alamat_sekarang')}}" placeholder="Alamat pasangan sekarang">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nomor_kpi') is-invalid @enderror" id="nomor_kpi" name="nomor_kpi" value="{{ old('nomor_kpi')}}" placeholder="nomor KPI pasangan">
                        @error('nomor_kpi')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nomor_surat_nikah') is-invalid @enderror" id="nomor_surat_nikah" name="nomor_surat_nikah" value="{{ old('nomor_surat_nikah')}}" placeholder="nomor surat nikah pasangan">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tempat_nikah') is-invalid @enderror" id="tempat_nikah" name="tempat_nikah" value="{{ old('tempat_nikah')}}" placeholder="tempat nikah pasangan">
                        @error('tempat_nikah')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nomor_kta_jalasenastri') is-invalid @enderror" id="nomor_kta_jalasenastri" name="nomor_kta_jalasenastri" value="{{ old('nomor_kta_jalasenastri')}}" placeholder="No. KTA JASALASENASTRI pasangan">
                    ...
                    <div class="pt-4 border-top border-black">
                        <a class="text-decoration-none btn btn-blue text-white bg-gray" href="{{ route('personel.informasi-keluarga.index', $nrpGanti) }}">
