...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">
            ...
            @endphp
            <a class="text-decoration-none" href="{{ route('personel.tanggungan-keluarga.create', ['nrp' => $nrpGanti]) }}">
        ...
        <table class="table thead-light">
            <thead>
                <tr class="bg-blueaccent text-white text-bold">
                    ...
                    <th scope="col" width="20%">STATUS HUBUNGAN</th>
                ...
                @else
                    @foreach ($tanggunganKeluarga as $data_tanggungan_keluarga)
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="{{ route('personel.tanggungan-keluarga.edit', ['nrp' => $nrpGanti, 'tanggunganKeluargaId' => $data_tanggungan_keluarga->id]) }}">
                                ...
                                <form action="{{ route('personel.tanggungan-keluarga.destroy', ['nrp' => $nrpGanti, 'tanggunganKeluargaId' => $data_tanggungan_keluarga->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
