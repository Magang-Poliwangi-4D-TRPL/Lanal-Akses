...
<div class="container">
    ...
    <div class="container bg-white border rounded p-5 mt-4">
        <div class="d-flex justify-content-between  my-3">
            ...
            <a class="text-decoration-none" href="{{ route('personel.perlengkapan.create', ['nrp' => $nrpGanti]) }}">
                ...
                @else
                    @foreach ($perlengkapan as $data_perlengkapan)
                        <tr>
                            ...
                            <td>
                                <a class="text-decoration-none" href="{{ route('personel.perlengkapan.edit', ['nrp' => $nrpGanti, 'perlengkapanId' => $data_perlengkapan->id]) }}">
                                ...
                                <form action="{{ route('personel.perlengkapan.destroy', ['nrp' => $nrpGanti, 'perlengkapanId' => $data_perlengkapan->id]) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
