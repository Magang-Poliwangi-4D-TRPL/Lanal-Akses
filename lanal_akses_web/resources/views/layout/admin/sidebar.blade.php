<div id="sidebar-collapse" class="sidebar fixed-top top-0 bottom-0 bg-greenmain  p-4 " style="height: 100%">
    <div id="sidebar-icon" class="d-flex justify-content-end">
    ...
    <a href="{{ url('/') }}" id="sidebar-brand" class="text-large text-white text-uppercase my-3"><img src="https://i.ibb.co/MR438ww/logo-no-bg.png" alt="logo-no-bg" border="0" width="30rem" height="auto" class="mr-2"><span id="sidebar-title">Lanal Akses</span> </a>

    <ul id="sidebar-menu" class="my-5 p-0">
        <a class="p-3 sidebar-item text-uppercase text-white rounded {{ (request()->is('admin')) ? 'active-sidebar-item' : '' }}" href="{{  url('#') }}">
            <iconify-icon class="mr-3" icon="ic:{{ (request()->is('admin')) ? 'home' : 'outline-home' }}" href="{{  url('#') }}home" width="24"></iconify-icon>
            <span class="sidebar-text">Dashboard</span>
        </a>
        <a class="p-3 sidebar-item text-uppercase text-white rounded {{ (request()->is('admin/pns')) ? 'active-sidebar-item' : '' }}" href="{{  url('#') }}" href="{{  url('#') }}">
            <iconify-icon class="mr-3" icon="material-symbols:group" width="24"></iconify-icon>
            <span class="sidebar-text">Data PNS</span>   
        </a>
        <a class="p-3 sidebar-item text-uppercase text-white rounded {{ (request()->is('admin/personil')) ? 'active-sidebar-item' : '' }}" href="{{  url('#') }}" href="{{  url('#') }}">
            <iconify-icon class="mr-3" icon="material-symbols:group" width="24"></iconify-icon>
            <span class="sidebar-text">Data Personil</span>
        </a>
        <a class="p-3 sidebar-item text-uppercase text-white rounded {{ (request()->is('admin/absensi')) ? 'active-sidebar-item' : '' }}" href="{{  url('#') }}" href="{{  url('#') }}">
            <iconify-icon class="mr-3" icon="mdi:clock" width="24"></iconify-icon>
            <span class="sidebar-text">Data Absensi</span>   
        </a>
        <a class="p-3 sidebar-item text-uppercase text-white rounded {{ (request()->is('admin/tambah')) ? 'active-sidebar-item' : '' }}" href="{{  url('#') }}" href="{{  url('#') }}">
            <iconify-icon class="mr-3" icon="ic:baseline-person-add" width="24"></iconify-icon>
...
<script>
    ...
    $("#icon-close").click(function(){
        ...
        $("#sidebar-brand").addClass("text-center");
        $("#logout-button").text("");
    ...
    $("#icon-menu").click(function(){
        ...
        $("#sidebar-brand").removeClass("text-center");
